...
const itineraryData = [
  ...
  { startTime: "2025-08-13T08:50:00", title: "大阪万博 西ゲート前 到着", points: "夜行バスお疲れ様！まず夢洲交通ターミナル1番を確認。シャトルバス事前予約済み（KANSAI MaaSアプリ）か最終チェック。10:30まで要予約のため注意！" },
  { startTime: "2025-08-13T09:00:00", title: "シャトルバス→JR桜島駅へ（最適ルート開始）", points: "西ゲート夢洲交通ターミナル1番から桜島駅へ15分（350円）。座席確保で子連れ安心。代替：東ゲート経由の電車ルート（35-40分、420円大人・210円子供、全駅エレベーター完備）" },
  ...
  { startTime: "2025-08-13T11:45:00", title: "UCW完全攻略完了→万博会場帰還作戦", points: "滞在1時間半で大満足！JR+シャトルバスで西ゲートへ。基本予算：4,700円（往復交通費1,200円、たこ焼き食べ比べ3,000円、軽食・飲み物500円）" },
